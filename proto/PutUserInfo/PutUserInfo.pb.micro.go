...
func (c *putUserInfoService) Call(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "PutUserInfo.Call", in)
	out := new(Response)
...
func (h *putUserInfoHandler) Call(ctx context.Context, in *Request, out *Response) error {
	return h.PutUserInfoHandler.Call(ctx, in, out)
}
