...
func (c *getSessionService) Call(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *getSessionHandler) Call(ctx context.Context, in *Request, out *Response) error {
